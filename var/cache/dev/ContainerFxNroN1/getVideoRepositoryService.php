...
return $this->privates['App\\Repository\\VideoRepository'] = new \App\Repository\VideoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()), ($this->services['knp_paginator'] ?? $this->load('getKnpPaginatorService.php')));
