...
include_once $this->targetDirs[3].'\\src\\DataFixtures\\SubscriptionFixtures.php';
...
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\CommentFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\SubscriptionFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\UserFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\VideoFixtures(), 'groups' => []]]);
