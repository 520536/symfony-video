...
class __TwigTemplate_7c3b13d6d69ac345d15ede9731602423cc87ec9cd6d6381a47f32b6c57673283 extends \Twig\Template
{
    private $source;
...
";
    ...
    <select name=\"category[parent]\" class=\"custom-select mr-sm-2\" id=\"inlineFormCustomSelect\">
        ";
        // line 12
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Extension\HttpKernelRuntime')->renderFragment(Symfony\Bridge\Twig\Extension\HttpKernelExtension::controller("App\\Controller\\Admin\\MainController::getAllCategories", ["editedCategory" => (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 12, $this->source); })())]));
        echo "
    </select>
...
";
    ...
    {
        return array (  94 => 19,  87 => 15,  81 => 12,  73 => 8,  69 => 5,  65 => 3,  56 => 2,  34 => 1,);
    }
...
{{ form_start(form, {'attr': {'novalidate':'novalidate'} }) }}
    ...
    <label for=\"inlineFormCustomSelect\">Parent:</label>
    <select name=\"category[parent]\" class=\"custom-select mr-sm-2\" id=\"inlineFormCustomSelect\">
        {{ render(controller('App\\\\Controller\\\\Admin\\\\MainController::getAllCategories',{'editedCategory':category})) }}
    </select>
    <div class=\"invalid-feedback\">
...
", "admin/edit_category.html.twig", "C:\\xampp\\htdocs\\my-project\\templates\\admin\\edit_category.html.twig");
    }
}
