...
class SecurityController extends AbstractController
{
		...
		if($this->isGranted('IS_AUTHENTICATED_REMEMBERED') && $plan == Subscription::getPlanDataNameByIndex(0))   //free plan
			{
				...
				$this->saveSubscription($plan,$this->getUser());      //to do save subscription
				return $this->redirectToRoute('admin_main_page');
    ...
    private function loginUserAutomatically($user, $password)   //自动跳转方法在下面
    {
