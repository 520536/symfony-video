...
class __TwigTemplate_89b56a9385b4ddbb9dba8d7868ef32cad51aadfaff1b42e67f63b2be9efc1324 extends \Twig\Template
{
    private $source;
...
";
        // line 15
        echo (isset($context["categories"]) || array_key_exists("categories", $context) ? $context["categories"] : (function () { throw new RuntimeError('Variable "categories" does not exist.', 15, $this->source); })());
        echo "
...
";
    ...
    <div class=\"col-md-4 mb-3\">
        ...
        // line 23
        echo "        ";
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 23, $this->source); })()), "name", [], "any", false, false, false, 23), 'widget', ["attr" => ["class" => ("form-control" . (isset($context["is_invalid"]) || array_key_exists("is_invalid", $context) ? $context["is_invalid"] : (function () { throw new RuntimeError('Variable "is_invalid" does not exist.', 23, $this->source); })())), "placeholder" => "Category name"], "id" => "validationServer01"]);
        echo "
        <br>
\t    <label for=\"inlineFormCustomSelect\">Parent:</label>
        <select name=\"category[parent]\" class=\"custom-select mr-sm-2\" id=\"inlineFormCustomSelect\">  <!--需要使用name与controller通信-->
            ";
        // line 27
        echo $this->env->getRuntime('Symfony\Bridge\Twig\Extension\HttpKernelRuntime')->renderFragment(Symfony\Bridge\Twig\Extension\HttpKernelExtension::controller("App\\Controller\\Admin\\MainController::getAllCategories"));
        echo "
        </select>
...
";
    ...
    {
        return array (  128 => 34,  121 => 30,  115 => 27,  107 => 23,  101 => 18,  96 => 15,  92 => 13,  83 => 12,  66 => 4,  57 => 3,  35 => 1,);
    }
...
\t    <label for=\"inlineFormCustomSelect\">Parent:</label>
        <select name=\"category[parent]\" class=\"custom-select mr-sm-2\" id=\"inlineFormCustomSelect\">  <!--需要使用name与controller通信-->
            {{ render(controller('App\\\\Controller\\\\Admin\\\\MainController::getAllCategories')) }}
        </select>
        <div class=\"invalid-feedback\">
...
", "admin/categories.html.twig", "C:\\xampp\\htdocs\\my-project\\templates\\admin\\categories.html.twig");
    }
}
